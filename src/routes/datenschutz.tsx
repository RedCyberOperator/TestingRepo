...
function DatenschutzPage() {
  return (
    ...
    >
      <LegalSection heading="Datenschutz auf einen Blick">
        <p>
        ...
        <p>
          ...
          Des Weiteren steht Ihnen ein Beschwerderecht bei der zuständigen Aufsichtsbehörde zu. Hierzu sowie zu
      ...
      <LegalSection heading="Hosting">
        <p>
          <strong>Wir hosten die Inhalte unserer Website bei folgendem Anbieter:</strong>
        </p>
        <p>
        ...
        <p>
          Wir setzen folgende(n) Hoster ein: Vercel
        </p>
        <p>
      ...
      <LegalSection heading="Allgemeine Hinweise und Pflichtinformationen">
        <p>
        ...
        <p>
          Vinzent & Felix Breitenstein
          <br />Telefon: +49 176 55423335
          <br />E‑Mail: info@fv‑webseiten.com
        </p>
        ...
        <p>
          <strong>Widerspruchsrecht gegen die Datenerhebung in besonderen Fällen sowie gegen
          Direktwerbung (Art. 21 DSGVO)</strong>
        </p>
        <p>
        ...
        <p>
          <strong>Auskunft, Berichtigung und Löschung</strong>
        </p>
        <p>
        ...
        <p>
          ...
          folgenden Fällen: Wenn Sie die Richtigkeit Ihrer bei uns gespeicherten personenbezogenen Daten bestreiten,
          benötigen wir in der Regel Zeit, um dies zu überprüfen. Für die Dauer der Prüfung haben Sie das Recht, die
          Einschränkung der Verarbeitung Ihrer personenbezogenen Daten zu verlangen. Wenn die Verarbeitung Ihrer
          personenbezogenen Daten unrechtmäßig geschah/geschieht, können Sie statt der Löschung die Einschränkung
          der Datenverarbeitung verlangen. Wenn wir Ihre personenbezogenen Daten nicht mehr benötigen, Sie sie jedoch
          zur Ausübung, Verteidigung oder Geltendmachung von Rechtsansprüchen benötigen, haben Sie das Recht,
          statt der Löschung die Einschränkung der Verarbeitung Ihrer personenbezogenen Daten zu verlangen.
        </p>
      </LegalSection>

      <LegalSection heading="Datenerfassung auf dieser Website">
        <p>
      ...
      <LegalSection heading="Plugins und Tools">
        <p>
